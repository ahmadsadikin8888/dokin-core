                    ...
                    <div class="page-header">
                        ...
                        <div class="page-header-top">
                            <div class="container">
                                ...
                                <div class="page-logo">
                                    <a href="index.html">
                                        <img src="{{ asset('assets/metronic/assets/layouts/layout3/img/logo-default.jpg') }}" alt="logo" class="logo-default">
                                    </a>
                                </div>
                                <!-- END LOGO -->
                                                ...
                                                <li>
                                                    <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <span class="photo">
                                                                    <img src="{{ asset('assets/metronic/assets/layouts/layout3/img/avatar1.jpg') }}" class="img-circle" alt=""> </span>
                                                                <span class="subject">
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <span class="photo">
                                                                    <img src="{{ asset('assets/metronic/assets/layouts/layout3/img/avatar2.jpg') }}'" class="img-circle" alt=""> </span>
                                                                <span class="subject">
                                                                    <span class="from"> Lisa Wong </span>
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <span class="photo">
                                                                    <img src="{{ asset('assets/metronic/assets/layouts/layout3/img/avatar3.jpg') }}" class="img-circle" alt=""> </span>
                                                                <span class="subject">
                                                                    <span class="from"> Richard Doe </span>
