                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="portlet box green">
                                                    <div class="portlet-title">
                                                        ...
                                                        <div class="actions">
                                                            <a href="{{ route('produks.create') }}" class="btn btn-success btn-sm btn-circle">
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover table-header-fixed" id="sample_2">
                                                            ...
                                                            <tbody>
																...
																<tr>
																	...
																	<td>
																		{!! Form::open(['method' => 'DELETE','route' => ['produks.destroy', $user->id],'style'=>'display:inline']) !!}
																			
																			<!--<a href="{{ route('users.show',$user->id) }}" class="btn btn-icon-only blue"><i class="fa fa-file-o"></i></a>-->
																			<a href="{{ route('produks.edit',$user->id) }}" class="btn btn-icon-only yellow"><i class="fa fa-edit"></i></a>
