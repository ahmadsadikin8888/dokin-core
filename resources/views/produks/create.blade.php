                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                            ...
                                                            <div class="portlet light ">
                                                                ...
                                                                @endif
                                                                {!! Form::open(array('route' => 'produks.store','method'=>'POST','enctype'=>'multipart/form-data')) !!}
                                                                          ...
                                                                          <div class="tab-pane active" id="tab_1_1">
                                                                               <div class="form-group">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" placeholder="100000" name="price" class="form-control" value=""/> </div>
                                                                                <div class="form-group">
