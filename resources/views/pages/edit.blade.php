                                                            ...
                                                            <div class="portlet light ">
                                                                <div class="portlet-title tabbable-line">
                                                                    <div class="caption caption-md">
                                                                        ...
                                                                        <span class="caption-subject font-blue-madison bold uppercase">Page Content</span>
                                                                    </div>
                                                                    <ul class="nav nav-tabs">
                                                                        <li class="active">
                                                                            <a href="#tab_1_1" data-toggle="tab">Page Content</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="#tab_1_2" data-toggle="tab">Page Image</a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="#tab_1_3" data-toggle="tab">Page Seo</a>
                                                                        </li>
                                                                   </ul>
                                                                </div>
                                                                ...
                                                                @endif
                                                                {!! Form::model($post, ['method' => 'PATCH','route' => ['pages.update', $post->id],'enctype'=>'multipart/form-data']) !!}
                                                                               ...
                                                                               <div class="form-group">
                                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                                        <div class="fileinput-new thumbnail" style="width: 1100px; height: 300px;">
                                                                                            <img src="{{asset('uploads/pages/original/'.$post->image)}}" alt="" /> </div>
